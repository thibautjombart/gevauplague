...
The generation time distribution $\mathcal{H}$ can be calculated by convolving the infectious period $\mathcal{F}$ and the  incubation time distribution $\mathcal{G}$.
