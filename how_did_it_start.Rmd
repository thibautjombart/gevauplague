...
Quintin. There remains the possibility that infected surfaces (clothes,
bedsheets) were infected by _Y. pestis_, which has been shown to be able to last
up to 5 days [@Rose2003-og]. We can replicate the same analysis subtracting
these 5 days from the overal delay:
